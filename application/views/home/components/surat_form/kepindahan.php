<div class="container">
    <h3 class="fw-semibold">Data Perpindahan</h3>
    <div class="row mt-4">
        <div class="col-lg-6">
            <div class="mb-5">
                <label for="exampleInputEmail1" class="form-label">Alamat Asal *</label>
                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="alamat-asal" required>
            </div>
        </div>
        <div class="col-lg-6">
            <div class="mb-5">
        ...
        <div class="col-lg-6">
            <div class="mb-5">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="alasan-pindah" required>
            </div>
        </div>
