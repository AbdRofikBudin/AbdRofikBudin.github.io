          ...
          <div class="container-fluid">
              ...
              <div class="card card-warning">
                  <div class="card-header">
                      <h3 class="card-title">Detail Data Kelahiran</h3>
                  </div>
                  <!-- /.card-header -->
                  <div class="card-body">
                          ...
                          <div class="row">
                              <div class="col-sm-6">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" disabled value="<?= $letter->mother_name ?>">
                                  </div>
                              </div>
                              <div class="col-sm-6">
                                  <div class="form-group">
                                      <label>Nama Ayah</label>
                                      <input type="text" class="form-control" disabled value="<?= $letter->father_name ?>">
                                  </div>
                              </div>
                          </div>
                          <div class="row">
                              <div class="col-sm-6">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" disabled value="<?= $letter->baby_name ?>">
                                  </div>
                              </div>
                              <div class="col-sm-6">
                                  <div class="form-group">
                                      <label>Tempat Lahir</label>
                                      <input type="text" class="form-control" disabled value="<?= $letter->birth_place ?>">
                                  </div>
                              </div>
                          </div>
                          <div class="row">
                              <div class="col-sm-6">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" disabled value="<?= date('d M Y', strtotime($letter->birth_date)) ?>">
                                  </div>
                              </div>
                              <div class="col-sm-6">
                                  <div class="form-group">
                          ...
                          <div class="row">
                              <div class="col-sm-6">
                                  <!-- text input -->
                                  <div class="form-group">
                                      <label>Lampiran Surat Keterangan Bidan</label>
                                      <div id="MainImages">
                                          <img src="<?= base_url('assets/letter_request/img/' . $letter->att_ket_bidan) ?>" alt="surket-bidan" class="birth" width="500" />
                                      </div>
                                      <div id="FullscreenBirth" style="display: none; z-index: 999;">
                                          <img src="" alt="" />
                                      </div>
                                  </div>
                              </div>
                                  ...
                                  <div class="modal-content">
                                      ...
                                      <form action="<?= site_url('adminpanel/change_to_success/' . $letter->id_letter) ?>" method="post">
                                          <div class="modal-body">
                                              ...
                                              <div class="mb-3">
                                                  <label for="exampleFormControlTextarea1" class="form-label">Masukan Nomor Surat Kelahiran</label>
